...
# name of array
canvas.create_text(x1 - 30, y1 + 25, text="Arr",
                   font="none 20 bold", fill="Black")
...
for i in range(num):
    # index of array
    canvas.create_text(txt_xpos, txt_ypos - 10, text=i,
                       font="none 10", fill="Black")
    txt_xpos += 50
...
for i in range(num):
    values.append(canvas.create_text(txt_x1, txt_y1,
                                     text=element_array[i], font="none 20 bold"))
    txt_x1 += 50
